...
class TestDriveFile:
    ...
    def test_creates_file_with_required_fields(self):
        ...
        assert file.name == "Budget 2026.xlsx"
    ...
    def test_file_to_dict(self):
        ...
        file = DriveFile(
            ...
            name="Budget 2026",
            mime_type="application/vnd.google-apps.spreadsheet",
            modified_time=datetime(2026, 1, 7, 10, 0, tzinfo=timezone.utc),
            source_account="personal"
        )
        data = file.to_dict()
...
class TestDriveService:
    ...
    def test_searches_by_filename(self, drive_service):
            ...
            "files": [
                {
                    ...
                    "modifiedTime": "2026-01-07T10:00:00.000Z",
                }
            ]
        }
        ...
        assert len(files) >= 1
        assert files[0].name == "Budget 2026"
    ...
    def mock_drive_service(self):
        ...
        mock.search.return_value = [
            DriveFile(
                ...
                name="Budget 2026",
                mime_type="application/vnd.google-apps.spreadsheet",
                modified_time=datetime(2026, 1, 7, tzinfo=timezone.utc),
                source_account="personal",
            )
        ]
        return mock
